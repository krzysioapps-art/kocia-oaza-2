                                ...
                                (filter) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            type="button"
                                            className={`public-cats__filter ${active
                                                    ? "is-active"
                                                    : ""
                                    ...
                                    (filter) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                type="button"
                                                className={`public-cats__modal-option ${active
                                                        ? "is-active"
                                                        : ""
                                            ...
                                            (tag) => {
                                                ...
                                                return (
                                                    <button
                                                        key={tag}
                                                        type="button"
                                                        className={`public-cats__modal-tag ${active
                                                                ? "is-active"
                                                                : ""
                                                            }`}
                                                        onClick={() =>
                        ...
                        (cat) => {
                            ...
                            return (
                                <Link
                                    key={cat.id}
                                    href={`/koty/${cat.slug}`}
                                    className={`public-cat-card ${isDeceased
                                ...
                                >
                                    <div className="public-cat-card__image-wrap">
                                        ...
                                        <div
                                            className={`public-cat-card__status public-cat-card__status--${cat.status ??
                                                "available"
                                                }`}
                                        >
                                            {isDeceased ? (
